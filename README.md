...
![Imgur](https://i.imgur.com/dh9iRio.png)

Amethyst backend for Project Amethyst [JavaScript](https://en.wikipedia.org/wiki/JavaScript)

Created by RickyonGit98 [Burlone](https://github.com/RickyonGit98), used a similar structure as [Lawin](https://github.com/Lawin0129)
...
* BattlePass (s2-s20):
    * [x] Possibility to buy the Amethyst Pass.
    * [x] Possibility to purchase Amethyst Pass levels.
    * [x] Possibility to gift the Amethyst Pass (BETA).
...
- `/fulllocker {user}` - Allows you to give a user all cosmetics. Note: This will reset all your lockers to default
- `/vbucks {user} {vbucks}` - Lets you change a users amount of vbucks
...
1) Go to **Config/config.json** in the directory you extracted Amethyst into.
...
1) Go to **Config/config.json** in the directory you extracted Amethystinto.
...
2) **Download** and **Extract** Amethystto a safe location.
3) Run **"install_packages.bat"** to install all the required modules.
4) Go to **Config/config.json** in the directory you extracted Amethystinto.
